...
def colliderect_on_bg(bully, victim):
    temp_victim = copy(victim) # shallow copy the variable
...
while True:
    ...
    if collidepoint_on_bg(mario_rect, question_rect10.midbottom):
        ...
        # Only draw mushroom for the first time of collision
    ...
    if draw_mushroom1:
        ...
        if red_mushroom_rect1.bottom > question_rect10.top:
            red_mushroom_rect1.top -= 3
    ...
    if draw_mushroom2:
        ...
        # Let the mushroom rise slowly
        if red_mushroom_rect2.bottom > question_rect11.top:
            red_mushroom_rect2.top -= 3

    if draw_empty_brick11:
        draw_on_bg(empty_brick, rect = question_rect11)

    if red_mushroom_rect2.bottom <= question_rect11.top and colliderect_on_bg(mario_rect, red_mushroom_rect2):
    ...
    if draw_mushroom3:
        ...
        # Let the mushroom rise slowly
        if red_mushroom_rect3.bottom > question_rect12.top:
            red_mushroom_rect3.top -= 3

    if draw_empty_brick12:
        draw_on_bg(empty_brick, rect = question_rect10)

    if red_mushroom_rect3.bottom <= question_rect12.top and colliderect_on_bg(mario_rect, red_mushroom_rect3):
